...
if (!chat.isBanned && chat.audios && m.text.match(/(cigarro|fumo|fumó|fuma|🚬|burunya|nya|nia)/gi)) {
...
if (!chat.isBanned && chat.audios && m.text.match(/(esnifar|coca|jalar|droga|marihuana|snifar|drogarse)/gi)) {    
let vn = './media/snifar_coca.m4a'
this.sendPresenceUpdate('recording', m.chat)   
this.sendMessage(m.chat, { audio: { url: vn }, fileName: 'error.mp3', mimetype: 'audio/mp4', ptt: true }, { quoted: m })}    
    
if (!chat.isBanned && chat.audios && m.text.match(/(cariñosas|prostituta|prostitutas|puta|putas|maraca)/gi)) {    
...
if (/^A Bueno master|Bueno master|me retiro|adios|chao|bye|me voy|me marcho|Bueno Máster|🫂$/i.test(m.text) && chat.audios) {  
...
if (chat.audios && m.text.match(/(Las reglas del grupo|lee|reglas|leíste|leiste)/gi)) {    
...
/*if (chat.audios && m.text.match(/(Momento equisde|momento equisde|xd|Xd|XD|xD|Momento|fuera|🥴|😨|🤘|👄|🕴️|💃|🕺)/gi)) {    
...
if (chat.audios && m.text.match(/(Te gusta el Pepino|🥒|🍆|nepe|pene|poronga|chota|pico|pichula|pito|aparato reproductor masculino)/gi)) {    
...
if (chat.audios && m.text.match(/(Traigan le una falda|ryu|Traiganle una falda|Nina|niña|niño|recum|reccom|gabriel|mati|jarok)/gi)) {    
...
if (chat.audios && m.text.match(/(TENGO LOS CALZONES|Tengo los calzones|tengo los calzones|🥶|😳|😱|😨|🙀|calzones|tanga)/gi)) {    
...
if (chat.audios && m.text.match(/(Bien pensado woody|wodi|woody|gody|gudi|wodi|bien pensado woody|Bien pensado|bien pensado|Bien pensado wudy|bien pensado wudy|Bien pensado Woody|bien pensado Woody|Bien pensado woodi|bien pensado woodi)/gi)) {    
let vn = './media/bien-pensado-woody.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
    
if (chat.audios && m.text.match(/(bañate|lava|bañar|Bañat)/gi)) {    
...
if (chat.audios && m.text.match(/(Me voy|me voy|ME VOY|Me fui|me fui|ME FUI|Se fue|se fue|SE FUE|Adios|adios|ADIOS|Chao|chao|CHAO|fuimonos)/gi)) {    
...
if (chat.audios && m.text.match(/(bebesita|bot canta|vale canta)/gi)) {
...
if (chat.audios && m.text.match(/(Yokese|yokese|YOKESE|nose|quizas|puede ser| y yo que se)/gi)) {    
...
if (chat.audios && m.text.match(/(gracioso|risa|hih|ajs)/gi)) {    
let vn = './st/j1.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(jsjs|jeje|heh|kaj)/gi)) {    
let vn = './st/j2.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(hola|wena)/gi)) {    
let vn = './st/1.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(buena|oa)/gi)) {    
let vn = './st/2.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (chat.audios && m.text.match(/(oli)/gi)) {    
let vn = './st/3.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (chat.audios && m.text.match(/(foto teta|pechugas|mamas|lola|pecho|uva)/gi)) {    
let vn = './st/ftt1.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}  

if (chat.audios && m.text.match(/(fototeta|chichi|senos|bubi)/gi)) {    
let vn = './st/ftt2.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}  
...
if (chat.audios && m.text.match(/(bien y tu|bien gracias|biem graciams|tú|Tú)/gi)) {    
let vn = './st/raw.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 

if (chat.audios && m.text.match(/(bot|valebot|BOT|Bot|vale)/gi)) {    
let vn = './st/vale.webp'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})} 
